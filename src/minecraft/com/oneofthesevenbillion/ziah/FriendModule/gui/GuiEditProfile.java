...
public class GuiEditProfile extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, 4, this.height - 20 - 8 - 20 - 4, 130, 20, "Done"));
        this.buttonList.add(new GuiButton(1, 4, this.height - 20 - 8, 130, 20, "Cancel"));
        this.buttonList.add(new GuiButton(2, 4 + this.fontRenderer.getStringWidth("Profile Picture: ") + 4, 111, 130, 20, "Change Profile Picture"));
        this.realname = new GuiTextField(this.fontRenderer, 4 + this.fontRenderer.getStringWidth("Realname: ") + 4, 55, 200, 20);
        this.realname.setFocused(true);
        this.realname.setText(ModuleFriend.getInstance().getPlayer().getRealname());
        this.description = new GuiTextField(this.fontRenderer, 4 + this.fontRenderer.getStringWidth("Description: ") + 4, 82, 200, 20);
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        int offsetY = 17;
        this.drawCenteredString(this.fontRenderer, "Edit Profile", offsetCenteredX, offsetY, 16777215);
        offsetY += 9;
        offsetY += 9;
        this.drawString(this.fontRenderer, "Username: " + ModuleFriend.getInstance().getPlayer().getUsername(), offsetX, offsetY, 10526880);
        offsetY += 9;
        offsetY += 9;
        offsetY += 9;
        this.drawString(this.fontRenderer, "Realname: ", offsetX, offsetY, 10526880);
        offsetY += 9;
        offsetY += 9;
        offsetY += 9;
        this.drawString(this.fontRenderer, "Description: ", offsetX, offsetY, 10526880);
        offsetY += 9;
        offsetY += 9;
        offsetY += 9;
        this.drawString(this.fontRenderer, "Profile Picture: ", offsetX, offsetY, 10526880);
        offsetY += 9;
        offsetY += 10;
